...
File 4-empty creates a script that creates an empty file called 4-empty.
...
File 13-change_group creates a script that changes the group owner to vincent for the file hello.
